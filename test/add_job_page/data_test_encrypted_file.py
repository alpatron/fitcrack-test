...
TEST_DATA = [
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_rar4_encrypted_header.rar').absolute(),
        expected_hash='$RAR3$*0*1baaa857e88ceb60*71a3824ad520bce18d280f721c66425c',
        expected_hash_type='RAR3-hp'
    ), id='rar4_encrypted_header'),
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_rar4_unencrypted_header.rar').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_rar5_encrypted_header.rar').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_rar5_unencrypted_header.rar').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_zip_new_encryption.zip').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file_zip_old_encryption.zip').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file.7z').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file.pdf').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file.ppt').absolute(),
    ...
    pytest.param(EncryptedFileTestInput(
        filepath=Path('./test/add_job_page/fc_auto_test_encrypted_file.pptx').absolute(),
