...
class PageObject:
    ...
    see the `ensure_loaded` doc string). You can supress the running of `ensure_loaded` by
    specifying using the parameter `no_ensure_loaded=True` when creating a page object.
    This is neccessary when creating the first object in a script, as the web browser starts on
    blank page.'''
    ...
    def ensure_loaded(self) -> None:
        ...
        The default, non-overriden method performs no checks and returns immediately.
