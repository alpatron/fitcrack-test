...
class MaskFileSelection(GenericEnableableTableRow):
    """This class represents a row from the mask-file-selection table on the brute-force
    ...
    @property
    def name(self) -> str:
        """The file name of the mask file."""
