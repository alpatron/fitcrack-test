...
testdata = [
    HybridTestInput(
        ...
        hashes=[
            ...
            ('0085411372df2865c07d45c20345caedbfdae958', None),
            ('2e7359ed0f945aeab3bae275f3d1f487451ed48b', None),
    ...
    HybridTestInput(
        hash_type='sha1',
        hashes=[
            ('06a3f6380a7f9a76462e2edbdaefe718eb9ea033', None),
            ('0085411372df2865c07d45c20345caedbfdae958', None),
            ('2e7359ed0f945aeab3bae275f3d1f487451ed48b', 'heyjurgen'),
            ('3650c195b6eb82db3818ec19c7c055b6f91b9675', None),
            ('341b5129bf9b6abcbd96ecaf158506090f9d77b5', 'bart825')
        ],
    ...
    HybridTestInput(
        ...
        hashes=[
            ...
            ('2e7359ed0f945aeab3bae275f3d1f487451ed48b', None),
            ('3650c195b6eb82db3818ec19c7c055b6f91b9675', None),
            ('341b5129bf9b6abcbd96ecaf158506090f9d77b5', None)
        ],
        mode=HybridMode.MASK_FIRST,
        dictionaries=['honeynet.txt'],
        rule='c $-',
