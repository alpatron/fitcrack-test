...
from page_object.pcfg_grammar_selection import PCFGGrammarSelection
...
class PCFGAttackSettings(PageObject):
    ...
    def get_available_pcfg_grammars(self) -> List[PCFGGrammarSelection]:
        ...
        """
        return build_table_selection_objects_from_table(self.driver,self.__pcfg_grammar_selection_table,PCFGGrammarSelection)
    ...
    def get_available_rule_files(self) -> List[RuleFileSelection]:
        ...
        that can be selected for the PCFG attack.
        """
        return build_table_selection_objects_from_table(self.driver,self.__rulefile_selection_table,RuleFileSelection)
